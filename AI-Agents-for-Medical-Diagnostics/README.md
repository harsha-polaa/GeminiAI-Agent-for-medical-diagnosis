...
**To be able to run the code, please insert your Gemini API key within the `.env` file.**
**If you are a beginner use gemini-1.5-flash-latest to create the gemini API key as it is free of cost** 